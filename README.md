...
A lightweight CLI tool for creating, organizing, and managing your personal bash scripts. Store scripts in a structured vault, install them from GitHub, and back everything up — without leaving the terminal.
